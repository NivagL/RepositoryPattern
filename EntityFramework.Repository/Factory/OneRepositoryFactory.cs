...
public class OneRepositoryFactory<TContext, TKey, TValue> 
    ...
    where TKey : notnull
{
    ...
    private readonly ILogger<OneRepositoryFactory<TContext, TKey, TValue>> Logger;
    ...
    public OneRepositoryFactory(IConfiguration configuration, 
        ILogger<OneRepositoryFactory<TContext, TKey, TValue>> logger)
    {
